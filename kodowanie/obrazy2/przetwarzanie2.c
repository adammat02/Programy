...
/************************************************************************************
 * Funkcja wykonuje operacje konwersje koloru obrazu w formacie PPM                 *
 *                                                                                  *
 * \param[out] piksele - tablica, do ktorej zostanie zapisany obraz po operacji     *
 * \param[in]  piksele - tablica, z ktorej zostanie pobrany obraz zrodlowy          *
 * \param[in]  wym_x - szerokosc obrazka                                            *
 * \param[in]  wym_y - wysokosc obrazka                                             *
 * \param[in] czerwono - czy czerwony zostawiamy                                    *
 * \param[in] zielono - czy zielony zostawiamy                                      *
 * \param[in] niebiesko - czy niebieski zostawiamy                                  *
 ************************************************************************************/
 ...
 *                                                                                  *
 * \param[in] nazwa_nowego - nazwa obrazu, ktory ma byc wyswietlony                 *
 ************************************************************************************/
